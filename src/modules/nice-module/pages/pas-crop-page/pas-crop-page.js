...
import './pas-crop-page.html'

class PasCropPage extends Permission(User(Polymer.Element))  {
  static get is () { return 'pas-crop-page' }
...
customElements.define(PasCropPage.is, PasCropPage)