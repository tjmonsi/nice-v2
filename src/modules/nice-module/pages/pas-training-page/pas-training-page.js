...
import './pas-training-page.html'

class PasTrainingsPage extends Permission(User(Polymer.Element))  {
  static get is () { return 'pas-training-page' }
...
customElements.define(PasTrainingsPage.is, PasTrainingsPage)